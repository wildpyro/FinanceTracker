'use strict';
var should = require('should'), request = require('supertest'), app = require('../../server'), mongoose = require('mongoose'), User = mongoose.model('User'), Stockposition = mongoose.model('Stockposition'), agent = request.agent(app);
/**
 * Globals
 */
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/stockpositions')
                ...
                agent.get('/stockpositions')
                    ...
                    // Handle Stockposition save error
                    if (stockpositionsGetErr)
                        done(stockpositionsGetErr);
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/stockpositions')
                ...
                agent.put('/stockpositions/' + stockpositionSaveRes.body._id)
                    ...
                    if (stockpositionUpdateErr)
                        done(stockpositionUpdateErr);
                    // Set assertions
...
//# sourceMappingURL=stockposition.server.routes.test.js.map