'use strict';
var should = require('should'), request = require('supertest'), app = require('../../server'), mongoose = require('mongoose'), User = mongoose.model('User'), Networth = mongoose.model('Networth'), agent = request.agent(app);
/**
 * Globals
 */
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/networths')
                ...
                agent.put('/networths/' + networthSaveRes.body._id)
                    ...
                    if (networthUpdateErr)
                        done(networthUpdateErr);
                    // Set assertions
...
//# sourceMappingURL=networth.server.routes.test.js.map