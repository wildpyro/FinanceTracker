'use strict';
var should = require('should'), request = require('supertest'), app = require('../../server'), mongoose = require('mongoose'), User = mongoose.model('User'), Stockpositiondetail = mongoose.model('Stockpositiondetail'), agent = request.agent(app);
/**
 * Globals
 */
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/stockpositiondetails')
                ...
                agent.get('/stockpositiondetails')
                    ...
                    // Handle Stockpositiondetail save error
                    if (stockpositiondetailsGetErr)
                        done(stockpositiondetailsGetErr);
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/stockpositiondetails')
                ...
                agent.put('/stockpositiondetails/' + stockpositiondetailSaveRes.body._id)
                    ...
                    if (stockpositiondetailUpdateErr)
                        done(stockpositiondetailUpdateErr);
                    // Set assertions
        ...
        agent.post('/auth/signin')
            ...
            agent.post('/stockpositiondetails')
                ...
                agent.delete('/stockpositiondetails/' + stockpositiondetailSaveRes.body._id)
                    ...
                    if (stockpositiondetailDeleteErr)
...
//# sourceMappingURL=stockpositiondetail.server.routes.test.js.map