'use strict';
var should = require('should'), request = require('supertest'), app = require('../../server'), mongoose = require('mongoose'), User = mongoose.model('User'), Account = mongoose.model('Account'), agent = request.agent(app);
/**
 * Globals
 */
...
//# sourceMappingURL=account.server.routes.test.js.map