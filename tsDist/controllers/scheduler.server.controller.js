 ...
 * Module dependencies.
 */
var schedule = require('node-schedule'), mongoose = require('mongoose'), mailer = require('nodemailer'), async = require('async'), quoteCtrl = require('./quotes.server.controller'), stockPositionsCtrl = require('./stockpositions.server.controller'), User = mongoose.model('User'), StockPositions = mongoose.model('StockPositions');
/**
...
//# sourceMappingURL=scheduler.server.controller.js.map