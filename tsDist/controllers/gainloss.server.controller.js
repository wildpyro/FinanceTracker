 ...
 * Module dependencies.
 */
var mongoose = require('mongoose'), errorHandler = require('./errors.server.controller'), GainLoss = mongoose.model('GainLoss'), _ = require('lodash');
/**
 * Create a GainLoss
 */
...
exports.list = function (req, res) {
    var query = GainLoss.find(), pagination = {
...
//# sourceMappingURL=gainloss.server.controller.js.map